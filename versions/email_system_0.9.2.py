...
def main():
    ...
    message = messageTemplate.substitute(CONTACT_NAME=full_name.title(), DATETIME_STRING=current_datetime.title())
...
def get_datetime():
    ...
    am_pm = current_datetime.strftime('%p').upper()
    current_datetime_str = current_datetime.strftime("%B %d, 20%y %I:%M %p" + am_pm)
