...
import cv2
import sys
from PyQt6.QtWidgets import QApplication, QMainWindow, QPushButton, QLabel, QVBoxLayout, QWidget, QHeaderView, QSizePolicy, QScrollArea, QTableWidget, QTableWidgetItem
...
def run_ocr_and_send_email():
    ...
    get_camera_image()
    filename = '/Users/ian/Desktop/HandwritingDetection/Project/jpegs/captured_image.png'
...
def get_camera_image():
    ...
    if not cap.isOpened():
        ...
        if ret:
            ...
            cv2.imwrite("jpegs/captured_image.png", frame)
